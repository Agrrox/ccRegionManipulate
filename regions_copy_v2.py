...
# * this program copies all 2drs and 3drs files from user specified bounding box to a new folders named ./region2dOutput/ and ./region3dOutput/
...
# TODO: print the ammount of files that will be copied to both directories
